...
public class Arrays {
	public static void main(String[] args) {
		...
		// 참조형 변수를 출력해보면 그 변수값이 저장된 곳의 시작번지가 출력됨
		
		// JVM의 메모리 구조
		// 스택 : 일반적인 변수(지역변수)가 선언될때 사용하는 공간
		...
		// 임의의 숫자 : 난수random
		// Random 클래스를 이용하면 원하는 형태의 난수 생성가능
		
		int[] lotto = new int[6];
		Random rnd = new Random();
		// 외부 라이브러리 이용하여 난수 생성, random이라는 클래스가 생김.
		// 난수표를 이용해서 난수 생성 //반복문에서 매번 초기화를 해줘야 정해진 값이 안나옴
		...
		// nextInt(45) =>  0 ~ 44	// 1 ~ 45 값을 얻기 위해 +1 해줌
