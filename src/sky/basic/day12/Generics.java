...
public class Generics {
    public static void main(String[] args) {
        ...
        // 컬렉션 클래스를 컴파일할때 자료형검사(타입체크)를 해주는 기능

        // 즉, 클래스에 사용할 타입의 정보를 동적으로 넘겨줄 수 있고
        // 실행시간(실행할때)에 발생할 수 있는 타입간 오류를 컴파일시간(컴파일할때)에
        // 발견할 수 있도록 해주는 기능
        // JDK 1.5에서 부터 추가된 기능
        ...
        // 컴파일할때는 아무 오류 없다가 실행할때서야 비로소 오류가 출력됨
