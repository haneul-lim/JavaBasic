...
public class JDBCCRUD {
    public static <stmt> void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        String amz = "bigdata.czzbjaoksklg.ap-northeast-2.rds.amazonaws.com";
        ...
        String sql = String.format(newbooksql2, bookid,
                bookname, publish, price);
